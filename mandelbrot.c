...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/07 15:20:34 by kganeriw          #+#    #+#             */
/*   Updated: 2024/02/09 16:43:33 by kganeriw         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	mandelbrot_init(t_data *data)
{
	...
	data->win_ptr = mlx_new_window(data->mlx_ptr, WIDTH, HEIGHT, "Mandelroot");
...
void	mandelbrot(t_data *data)
{
	...
	while (x < data->width)
	{
		...
		while (y < data->height)
		{
			...
			n = find_n(data->cre, data->cim, data->color * n);
			y++;
		}
		x++;
	}
